...
We fit a linear regression model for exam points with three explanatory variables. The explanatory variables, *Attitude*, *stra*, and *surf*,  are chosen by looking at the correlations of variable points with other variables.   
