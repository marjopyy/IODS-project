...
The box plot below shows that the differences in weight change is quite clear between groups. Group 2 seems to have an oulier whose weight change is exceptionally low. I remove this observation and draw the box plot again.
...
(with risk of falsely assuming a group difference 0.007), even after accounting for differences in rats' weights at first measurement. Thus, according to these preliminary analyses, the diet seems to have a statistically significant effect of rats' weight growth. 
...
not statistically significant. The effect of time (week) is the same, but the standard error is larger. The variance of the random terms related to the slope of the regression line is small,
suggesting that the individual-specific variation in the slopes may not be large. However,
according to the likelihood ratio test, the model with both random intercept and slope fits the data better.
